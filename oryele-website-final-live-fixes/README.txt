...
WWW SUBDOMAIN
www.oryele.ai must return a permanent 301 redirect to the matching path on https://oryele.ai. See CLOUDFLARE-SEO-SETUP.txt for the exact rule and DNS requirement.
